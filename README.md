...
| ---- | ----------- |-----|
| [botbuilder-config](libraries/botbuilder-config/README.md) | Consume/decrypt bot files | [![NPM Version](https://img.shields.io/badge/npm-0.5.1-red.svg)](https://www.npmjs.com/package/botbuilder-config) |
...
| ---- | ----------- |-------|
=======
| [botbuilder-azuretablestorage](libraries/botbuilder-azurestablestorage/README.md) | Use Azure Table Storage in your bot | [![NPM Version](https://img.shields.io/badge/npm-0.1.1-red.svg)](https://www.npmjs.com/package/botbuilder-azuretablestorage) |
